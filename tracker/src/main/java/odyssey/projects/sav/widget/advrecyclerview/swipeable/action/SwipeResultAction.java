...
package odyssey.projects.sav.widget.advrecyclerview.swipeable.action;
...
public abstract class SwipeResultAction {
    ...
    /**
     * This method is called immediately after returning from the {@link odyssey.projects.sav.widget.advrecyclerview.swipeable.SwipeableItemAdapter#onSwipeItem(RecyclerView.ViewHolder, int, int)} method.
